...
$query = mysqli_query($koneksi, "SELECT * FROM hargasampah WHERE id_sampah = '$id_sampah'");
// $sql = "SELECT * FROM calon_siswa WHERE id=$id";
// $query = mysqli_query($db, $sql);
$hargasampah = mysqli_fetch_assoc($query);
    ...
    <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">Edit Harga Sampah</h2>
                        <form class="form-horizontal" method="post" action="hargasampah-proses-edit.php">
                          <div class="form-group">
                            <label for="" class="">Nama Sampah</label>
                            <div class="col-6">
                              <input type="text" class="form-control" name="namaSampah" value="<?php echo $hargasampah['namaSampah']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="" class="">Harga Sampah</label>
                            <div class="col-6">
                              <input type="number" class="form-control" name="hargaSampah" value="<?php echo $hargasampah['hargaSampah']; ?>" required="">
                            </div>
                          </div>
                          <div class="col-6">
