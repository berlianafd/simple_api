...
$query = mysqli_query($koneksi, "SELECT * FROM konversi_poin WHERE id = '$id'");
// $sql = "SELECT * FROM calon_siswa WHERE id=$id";
// $query = mysqli_query($db, $sql);
$konversipoin = mysqli_fetch_assoc($query);
    ...
    <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">Edit Konversi Poin</h2>
                        <form class="form-horizontal" method="post" action="konversipoin-proses-edit.php">
                          <div class="form-group">
                            <label for="" class="">Total Poin</label>
                            <div class="col-6">
                              <input type="number" class="form-control" name="poin" value="<?php echo $konversipoin['poin']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="" class="">Total Harga</label>
                            <div class="col-6">
                              <input type="number" class="form-control" name="harga" value="<?php echo $konversipoin['harga']; ?>" required="">
                            </div>
                          </div>
                          <div class="col-6">
