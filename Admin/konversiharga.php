  ...
  <div class="row tm-content-row">
    <div class="col-12 tm-block-col">
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        <p class="text-white">Konversi Harga Sampah</p>
        <table class="table table-hover">
          ...
          <tbody>
            <?php
            $query = mysqli_query($koneksi,"SELECT * FROM konversiharga");

            while($menu = mysqli_fetch_array($query)){
              echo "<tr>";
              echo "<td><center>".$menu['id_jenis']."</center></td>";
              echo "<td><center>".$menu['nama_jenis']."</center></td>";
              echo "<td><center>".$menu['harga']."</center></td>";
              echo "<td><center>".$menu['poin']."</center></td>";
              echo "<td><center>";
              echo "<a class='btn btn-info' href='konversiharga-edit.php?id_jenis=".$menu['id_jenis']."'>Edit</a> ";
              echo "</center></td>";
              echo "</tr>";
            }
