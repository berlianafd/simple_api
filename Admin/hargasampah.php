  ...
  <div class="row tm-content-row">
    <div class="col-12 tm-block-col">
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        <p class="text-white">Harga Sampah</p>
        <table class="table table-hover">
          ...
          <tbody>
            <?php
            $query = mysqli_query($koneksi,"SELECT * FROM hargasampah");

            while($menu = mysqli_fetch_array($query)){
              echo "<tr>";

              echo "<td><center>".$menu['id_sampah']."</center></td>";
              echo "<td><center>".$menu['namaSampah']."</center></td>";
              echo "<td><center>".$menu['hargaSampah']."</center></td>";
              echo "<td><center>";
              echo "<a class='btn btn-info' href='hargasampah-edit.php?id_sampah=".$menu['id_sampah']."'>Edit</a> ";
              echo "</center></td>";
              echo "</tr>";
            }
